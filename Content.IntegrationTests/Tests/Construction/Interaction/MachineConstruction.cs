...
public sealed class MachineConstruction : InteractionTest
{
    ...
    public async Task ConstructProtolathe()
    {
        ...
        await Interact(ProtolatheBoard, Bin1, Bin1, Manipulator1, Manipulator1, Beaker, Beaker, Screw); // starcup: preserve matter bins
    ...
    public async Task DeconstructProtolathe()
    {
        ...
        await AssertEntityLookup(
            ...
            (Cable, 1),
            (Beaker, 2),
            (Manipulator1, 2), // starcup: preserve matter bins
            (Bin1, 2), // starcup: preserve matter bins
            (ProtolatheBoard, 1));
    }
    ...
    public async Task ChangeMachine()
    {
        ...
        AssertPrototype(MachineFrame);
        await Interact(Bin1, Bin1, Bin1, Manipulator1, Glass, Screw); // starcup: preserve matter bins
