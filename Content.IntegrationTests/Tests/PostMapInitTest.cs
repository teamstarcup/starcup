...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest : GameTest
    {
        ...
        private static readonly Dictionary<string, HashSet<EntProtoId>> DoNotMapWhitelistSpecific = new()
        {
            ...
            {"/Maps/_starcup/reach.yml", ["HandheldCrewMonitor"]}, // starcup: moved to starcup namespace
        ...
        public static readonly string[] GameMaps = GameDataScrounger.PrototypesOfKind<GameMapPrototype>().Where(x => x != PoolManager.TestMap).ToArray(); // starcup: made public for tests
