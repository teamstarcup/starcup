...
/// Allows mobs to spawn structures with <see cref="SpawnWindowAbilityComponent"/>.
/// </summary>
public abstract partial class SharedSpawnWindowAbilitySystem : EntitySystem
{
    // Managers
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SpawnWindowAbilityComponent, MapInitEvent>(OnMapInit);
        SubscribeLocalEvent<SpawnWindowAbilityComponent, ComponentShutdown>(OnCompRemove);
        SubscribeLocalEvent<SpawnWindowAbilityComponent, SpawnWindowAbilityActionEvent>(OnSpawnWindowAbilityStart);
        SubscribeLocalEvent<SpawnWindowAbilityComponent, SpawnWindowAbilityDoAfterEvent>(OnSpawnWindowAbilityDoAfter);
        SubscribeLocalEvent<SpawnWindowAbilityComponent, CloningEvent>(OnClone);
    }

    private void OnClone(Entity<SpawnWindowAbilityComponent> ent, ref CloningEvent args)
    {
        ...
        var cloneComp = Factory.GetComponent<SpawnWindowAbilityComponent>();
    ...
    /// </summary>
    private void OnMapInit(EntityUid uid, SpawnWindowAbilityComponent comp, MapInitEvent args)
    {
    ...
    /// </summary>
    private void OnCompRemove(EntityUid uid, SpawnWindowAbilityComponent comp, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, comp.ActionEntity);
    }

    private void OnSpawnWindowAbilityStart(EntityUid uid, SpawnWindowAbilityComponent comp, SpawnWindowAbilityActionEvent args)
    {
        ...
        var doAfter = new DoAfterArgs(EntityManager, uid, comp.ProductionLength, new SpawnWindowAbilityDoAfterEvent(), uid)
        {
    ...
    private void OnSpawnWindowAbilityDoAfter(EntityUid uid, SpawnWindowAbilityComponent comp, SpawnWindowAbilityDoAfterEvent args)
    {
        if (_timing.IsFirstTimePredicted)
...
/// </summary>
public sealed partial class SpawnWindowAbilityActionEvent : InstantActionEvent { }
