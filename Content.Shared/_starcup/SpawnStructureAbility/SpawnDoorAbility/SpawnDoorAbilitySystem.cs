...
/// Allows mobs to spawn structures with <see cref="SpawnDoorAbilityComponent"/>.
/// </summary>
public abstract partial class SharedSpawnDoorAbilitySystem : EntitySystem
{
    // Managers
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SpawnDoorAbilityComponent, MapInitEvent>(OnMapInit);
        SubscribeLocalEvent<SpawnDoorAbilityComponent, ComponentShutdown>(OnCompRemove);
        SubscribeLocalEvent<SpawnDoorAbilityComponent, SpawnDoorAbilityActionEvent>(OnSpawnDoorAbilityStart);
        SubscribeLocalEvent<SpawnDoorAbilityComponent, SpawnDoorAbilityDoAfterEvent>(OnSpawnDoorAbilityDoAfter);
        SubscribeLocalEvent<SpawnDoorAbilityComponent, CloningEvent>(OnClone);
    }

    private void OnClone(Entity<SpawnDoorAbilityComponent> ent, ref CloningEvent args)
    {
        ...
        var cloneComp = Factory.GetComponent<SpawnDoorAbilityComponent>();
    ...
    /// </summary>
    private void OnMapInit(EntityUid uid, SpawnDoorAbilityComponent comp, MapInitEvent args)
    {
    ...
    /// </summary>
    private void OnCompRemove(EntityUid uid, SpawnDoorAbilityComponent comp, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, comp.ActionEntity);
    }

    private void OnSpawnDoorAbilityStart(EntityUid uid, SpawnDoorAbilityComponent comp, SpawnDoorAbilityActionEvent args)
    {
        ...
        var doAfter = new DoAfterArgs(EntityManager, uid, comp.ProductionLength, new SpawnDoorAbilityDoAfterEvent(), uid)
        {
    ...
    private void OnSpawnDoorAbilityDoAfter(EntityUid uid, SpawnDoorAbilityComponent comp, SpawnDoorAbilityDoAfterEvent args)
    {
        if (_timing.IsFirstTimePredicted)
...
/// </summary>
public sealed partial class SpawnDoorAbilityActionEvent : InstantActionEvent { }

/// <summary>
/// Is relayed at the end of the spawning doafter.
/// </summary>
[Serializable, NetSerializable]
public sealed partial class SpawnDoorAbilityDoAfterEvent : SimpleDoAfterEvent { }
