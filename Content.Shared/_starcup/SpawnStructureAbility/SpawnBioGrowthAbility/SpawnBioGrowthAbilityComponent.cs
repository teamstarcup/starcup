...
/// </summary>
[RegisterComponent, NetworkedComponent, Access(typeof(SharedSpawnBioGrowthAbilitySystem)), AutoGenerateComponentState]
public sealed partial class SpawnBioGrowthAbilityComponent : Component
{
    /// <summary>
    ...
    [ViewVariables(VVAccess.ReadWrite)]
    [AutoNetworkedField]
    public EntProtoId Action = "ActionXenoBioGrowth";
