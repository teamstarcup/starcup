...
namespace Content.Shared.SpawnBioGrowthAbility;

/// <summary>
/// This is a modified duplicate of SericultureSystem.
/// Allows mobs to spawn structures with <see cref="SpawnBioGrowthAbilityComponent"/>.
/// </summary>
public abstract partial class SharedSpawnBioGrowthAbilitySystem : EntitySystem
{
    // Managers
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<SpawnBioGrowthAbilityComponent, MapInitEvent>(OnMapInit);
        SubscribeLocalEvent<SpawnBioGrowthAbilityComponent, ComponentShutdown>(OnCompRemove);
        SubscribeLocalEvent<SpawnBioGrowthAbilityComponent, SpawnBioGrowthAbilityActionEvent>(OnSpawnBioGrowthAbilityStart);
        SubscribeLocalEvent<SpawnBioGrowthAbilityComponent, SpawnBioGrowthAbilityDoAfterEvent>(OnSpawnBioGrowthAbilityDoAfter);
        SubscribeLocalEvent<SpawnBioGrowthAbilityComponent, CloningEvent>(OnClone);
    }

    private void OnClone(Entity<SpawnBioGrowthAbilityComponent> ent, ref CloningEvent args)
    {
        ...
        var cloneComp = Factory.GetComponent<SpawnBioGrowthAbilityComponent>();
    ...
    /// </summary>
    private void OnMapInit(EntityUid uid, SpawnBioGrowthAbilityComponent comp, MapInitEvent args)
    {
    ...
    /// </summary>
    private void OnCompRemove(EntityUid uid, SpawnBioGrowthAbilityComponent comp, ComponentShutdown args)
    {
        _actionsSystem.RemoveAction(uid, comp.ActionEntity);
    }

    private void OnSpawnBioGrowthAbilityStart(EntityUid uid, SpawnBioGrowthAbilityComponent comp, SpawnBioGrowthAbilityActionEvent args)
    {
        ...
        var doAfter = new DoAfterArgs(EntityManager, uid, comp.ProductionLength, new SpawnBioGrowthAbilityDoAfterEvent(), uid)
        {
        ...
        comp.SpawnStream = _audio.PlayPredicted(comp.SoundProgress, uid, uid)?.Entity;
    }
    ...
    private void OnSpawnBioGrowthAbilityDoAfter(EntityUid uid, SpawnBioGrowthAbilityComponent comp, SpawnBioGrowthAbilityDoAfterEvent args)
    {
        if (_timing.IsFirstTimePredicted)
            comp.SpawnStream = _audio.Stop(comp.SpawnStream);
        ...
        _audio.PlayPredicted(comp.SoundFinished, uid, uid);
...
/// </summary>
public sealed partial class SpawnBioGrowthAbilityActionEvent : InstantActionEvent { }

/// <summary>
/// Is relayed at the end of the spawning doafter.
/// </summary>
[Serializable, NetSerializable]
public sealed partial class SpawnBioGrowthAbilityDoAfterEvent : SimpleDoAfterEvent { }
