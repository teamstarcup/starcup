...
namespace Content.Shared._starcup.Flash.Components;
...
public sealed partial class FlashComponent : Component
{
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public TimeSpan MeleeDuration = TimeSpan.FromSeconds(0);

    /// <summary>
    /// For how long the target will lose vision when used in hand.
    /// </summary>
    [DataField, AutoNetworkedField]
    public TimeSpan AoeFlashDuration = TimeSpan.FromSeconds(0);
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public TimeSpan? MeleeStunDuration = TimeSpan.FromSeconds(0);
