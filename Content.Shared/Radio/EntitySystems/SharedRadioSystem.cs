...
public abstract partial class SharedRadioSystem : EntitySystem
{
    ...
    public void SendRadioMessage(EntityUid messageSource,
        ...
        FixedPoint2? frequency = null) // NF14 - added frequency
    {
        SendRadioMessage(messageSource, message, ProtoMan.Index(channel), radioSource, escapeMarkup: escapeMarkup, frequency); // NF14 - added frequency
    }
