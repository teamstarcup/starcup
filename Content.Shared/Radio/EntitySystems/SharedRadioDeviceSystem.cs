...
public abstract partial class SharedRadioDeviceSystem : EntitySystem
{
    ...
    private void OnExamine(Entity<RadioMicrophoneComponent> ent, ref ExaminedEvent args)
    {
        ...
        {
            // begin Frontier
            args.PushMarkup(Loc.GetString("starcup-handheld-radio-component-on-examine", // starcup
                ("frequency", ent.Comp.Frequency),
                ("color", proto.Color.ToHex())));
            args.PushMarkup(Loc.GetString("starcup-handheld-radio-component-channel-examine", // starcup
    ...
    private void OnListen(Entity<RadioMicrophoneComponent> ent, ref ListenEvent args)
    {
        ...
        if (_recentlySent.Add((args.Message, args.Source, channel)))
            _radio.SendRadioMessage(args.Source, args.Message, channel, ent.Owner, frequency: ent.Comp.Frequency); // NF14 - add frequency
    }
