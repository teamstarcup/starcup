        ...
        public bool SendNukeCodes(EntityUid station)
        {
            ...
            while (faxes.MoveNext(out var faxEnt, out var fax))
            {
                ...
                var printout = new FaxPrintout(
                    ...
                    {
                        new StampDisplayInfo { StampedName = Loc.GetString("stamp-component-stamped-name-centcom"), StampedColor = Color.FromHex("#BB3232"), StampLargeIcon = "large_stamp-centcom" },  // imp: added StampLargeIcon
                    }
                );
