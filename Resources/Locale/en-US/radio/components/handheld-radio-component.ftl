...
handheld-radio-component-on-examine = It's set to broadcast over the {$frequency} channel.
...
handheld-radio-current-text-frequency = Broadcast Channel
handheld-radio-button-text-mic = Mic.
handheld-radio-button-text-speaker = Spkr.
handheld-radio-flavor-text-left = HandiComms, Channels 1-3
# Nuclear-14-End
