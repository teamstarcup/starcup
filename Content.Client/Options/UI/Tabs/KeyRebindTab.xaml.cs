...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        public KeyRebindTab()
        {
            ...
            InitToggleWalk();
            AddCheckBox("ui-options-hotkey-walk-default", _cfg.GetCVar(SCCVars.WalkByDefault), HandleWalkDefault); // starcup
        ...
        // begin starcup
        private void HandleWalkDefault(BaseButton.ButtonToggledEventArgs args)
        {
            _cfg.SetCVar(SCCVars.WalkByDefault, args.Pressed);
            _cfg.SaveToFile();
        }
        // end starcup
